...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center;'>
                Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by <b>Aditya</b>
            </p>
            <p style='text-align: center; font-size: 12px; color: #888888;'>
                "Smart Resume Analyzer - Your Intelligent Career Partner"
            </p>
            """, unsafe_allow_html=True)
                        ...
                        try:
                            ...
                            with download_col2:
                                ...
                                try:
                                    ...
                                    st.warning(f"PDF generation encountered an issue. Downloading basic PDF version...")
                                    try:
                                        # Fallback: Create basic PDF from data
                                        pdf_buffer = self.pdf_exporter.create_pdf_from_data(
                                            resume_data,
                                            'modern'
                                        )
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <h2 class="profile-name">Aditya</h2>
    ...
    def render_analyzer(self):
        ...
        analyzer_tabs = st.tabs(["📊 ATS Analyzer & Enhancement", "Standard Analyzer", "AI Analyzer"])

        # TAB 0: ATS Analyzer & Enhancement (NEW - Assignment Feature)
                ...
                try:
                    ...
                    if not resume_text or len(resume_text.strip()) < 50:
                        ...
                        if 'analysis_results' in st.session_state:
                            ...
                            latex_template = st.selectbox(
                                "📐 Select LaTeX Template (for Overleaf)",
                                options=['modern', 'classic', 'academic', 'two_column'],
                                format_func=lambda x: {
                                    'modern': '🎨 Modern (Blue accents, professional)',
                                    'classic': '📜 Classic (Traditional, clean)',
                                    'academic': '🎓 Academic (CV style)',
                                    'two_column': '📊 Two Column (Compact)'
                                }[x],
                                key="latex_template_select"
                            )
                            ...
                            with export_col2:
                                ...
                                try:
                                    ...
                                    lines = results['enhanced_text'].split('\n')
                                    ...
                                    for line in lines:
                                        ...
                                        if line.isupper() or (len(line) > 0 and line[-1] == ':' and len(line.split()) <= 4):
                                            # Add section header
                                            heading = doc.add_heading(line.rstrip(':'), level=1)
                            ...
                            with export_col3:
                                ...
                                try:
                                    ...
                                    st.warning(f"PDF export: {str(e)}")

                            with export_col4:
                                # LaTeX download for Overleaf
                                try:
                                    latex_code = self.latex_generator.generate_latex(
                                        results['enhanced_text'],
                                    ...
                                    st.download_button(
                                        ...
                                        data=latex_code,
                                        file_name=f"enhanced_resume_{latex_template}.tex",
                                        mime="text/plain",
                                        use_container_width=True,
                                        help="Download LaTeX code to use in Overleaf"
                                    )

                                    # Show preview
                                    with st.expander("👁️ Preview LaTeX Code"):
                                        st.code(latex_code[:500] + "\n...\n[Full code in download]", language='latex')
                                        st.info("📝 Copy this code to Overleaf.com to compile your resume")

                                except Exception as e:
                                    st.error(f"LaTeX export error: {str(e)}")
